...
- [Docker CLI Reference: Build & Push](https://docs.docker.com/reference/cli/docker/) - Build & Push Commands

- [Snowflake External Access Integrations](https://docs.snowflake.com/en/sql-reference/sql/create-external-access-integration) - Outbound Network Rules
