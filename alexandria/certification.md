...
1. Redirect to below link and click create account https://learn.snowflake.com/en/certifications/
2. Create account using personal/Atrium Email ID https://cp.certmetrics.com/snowflake/en/login and make sure you select Partner as User Type and Select Atrium as the Partner.
3. An account verification email will be sent to your Certification account email address to validate your account. Click the link in the "Snowflake Certification Portal - New Account Verification" email and create a password for your account
4. Once login into certmetrics account, in the left menu panel go to Schedule and Manage Exam → Manage My Exam
5. Scrolling down, you will see the SnowPro Core Certification panel to register.
6. Schedule Your Exam as per your preferred date and time and apply coupon during checkout.
